...
class UnidadMedidaPolicy
{
    ...
    public function view(User $user, UnidadMedida $modelInstance): bool { return $this->isAdmin($user); }
    ...
    public function restore(User $user, UnidadMedida $modelInstance): bool { return $this->isAdmin($user); }
    public function forceDelete(User $user, UnidadMedida $modelInstance): bool { return $this->isAdmin($user); }
}
